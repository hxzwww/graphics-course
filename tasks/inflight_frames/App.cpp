...
App::App() : resolution{1280, 720}, useVsync{true} {
    ...
    // extensions are required for just about anything.
    {
        ...
        etna::initialize(etna::InitParams{
            ...
            .numFramesInFlight = numFramesInFlight_,
        });
    }
...
void App::drawFrame() {
    ...
    if (nextSwapchainImage) {
        ...
        ETNA_CHECK_VK_RESULT(currentCmdBuf.begin(vk::CommandBufferBeginInfo{}));
        {
            ...
            curBuffer_ = (curBuffer_ + 1) % numFramesInFlight_;
            auto ptr = buffers_[curBuffer_].map();
            std::memcpy(ptr, &constants, sizeof(constants));
            buffers_[curBuffer_].unmap();
            ...
            auto descriptorSet = etna::create_descriptor_set(
                ...
                {etna::Binding{0, image_.genBinding(cSampler_.get(),
                                                    vk::ImageLayout::eGeneral)},
                 etna::Binding{1, buffers_[curBuffer_].genBinding()}});
            ...
            auto descriptorSet2 = etna::create_descriptor_set(
                ...
                {etna::Binding{0, texture_.genBinding(
                                      gSampler_.get(),
